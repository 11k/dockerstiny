...
return [
    ...
    'commerce' => [
        ...
        'seconds_to_decay_per_dollar' => 30,
        'tiers' => [
            [
                'tier' => 1,
                'tierLabel' => 'Tier I',
                ...
                'benefits' => [
                    'A colorful username',
                    'Subscriber role in Discord',
                    'Participate in viewer call-ins',
                    'Cast 2 votes in sub-weighted polls',
                    'Mercy from the mod team',
                    'Destiny will call you "buddy"',
                ],
                'subscriptions' => ['1-MONTH-SUB', '3-MONTH-SUB'],
                'quote' => [
                    'text' =>
            ...
            [
                ...
                'benefits' => [
                    'A colorful username',
                    'Subscriber role in Discord',
                    'Priority during viewer call-ins',
                    'Cast 4 votes in sub-weighted polls',
                    'Even more mercy from mods',
                    'A firm handshake from Destiny',
                ],
                'subscriptions' => ['1-MONTH-SUB2', '3-MONTH-SUB2'],
                'quote' => [
                    'text' =>
            ...
            [
                ...
                'benefits' => [
                    ...
                    'Subscriber role in Discord',
                    'Priority during viewer call-ins',
                    'Cast 8 votes in sub-weighted polls',
                    'Mods will easily forgive your transgressions',
                    'Destiny will give you a consensual hug',
                ],
                'subscriptions' => ['1-MONTH-SUB3', '3-MONTH-SUB3'],
                'quote' => [
                    'text' =>
            ...
            [
                ...
                'benefits' => [
                    ...
                    'Subscriber role in Discord',
                    'Priority during viewer call-ins',
                    'Cast 16 votes in sub-weighted polls',
                    'Near-impenetrable ban armor',
                    'A photo with Destiny (no weird poses)',
                ],
                'subscriptions' => ['1-MONTH-SUB4', '3-MONTH-SUB4'],
                'quote' => [
                    'text' =>
            ...
            [
                ...
                'benefits' => [
                    'A colorful username',
                    'Subscriber role in Discord',
                    'First in line during viewer call-ins',
                    'Cast 32 votes in sub-weighted polls',
                    'Mods are reprimanded if they ban you',
                    'Destiny will pat your head lovingly for five seconds',
                ],
                'subscriptions' => ['1-MONTH-SUB5', '3-MONTH-SUB5'],
                'quote' => [
                    'text' => 'Destiny made me do this...',
                    'author' => 'Cake',
                ],
            ],
        ],
